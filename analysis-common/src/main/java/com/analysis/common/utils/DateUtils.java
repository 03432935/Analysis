...
public class DateUtils {
    ...
    private final String standard = "yyyy-MM-dd HH:mm:ss";
    ...
    /**
     *
     * @param string 类似2015/9/8 18:00转换成20150908 18:00:00
     * @return
     */
    ...
    public static String getNowTime() {
        SimpleDateFormat formate = new SimpleDateFormat(FORMAT_STRING);
    ...
    public static String getToDayStartTime() {
        SimpleDateFormat formate = new SimpleDateFormat(YYYY_MM_DD+STARTTIME);
        Date date = new Date(System.currentTimeMillis());
        return formate.format(date);
    }
    ...
    public static String getToDayEndTime() {
        SimpleDateFormat formate = new SimpleDateFormat(YYYY_MM_DD+ENDTIME);
        Date date = new Date(System.currentTimeMillis());
        return formate.format(date);
    }

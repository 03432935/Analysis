...
//     */
//    public DTree(double[] data, RandomForest forest, int num){
//        this.forest = forest;
//        N = data.length;
...
//     * @param nu    The Tree number
//     */
//    public ArrayList<Double> CalculateClasses(ArrayList<double[]> val, int nu){
//        ArrayList<Double> preList = new ArrayList<>();
//        int korect = 0;
//        for(double[] record : val){
//            double pre_label = Evaluate(record);
//            preList.add(pre_label);
//            double actual_label = record[record.length-1];
//            if (pre_label==actual_label) {
//                korect++;
//            }
//        }
